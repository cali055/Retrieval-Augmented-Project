...
from .nodes import (
    ...
    ainvoke_store_retrieved_sources_step,
...
class AgenticRAGService:
    ...
    def _build_graph(self):
        ...
        workflow.add_node("store_retrieved_sources", ainvoke_store_retrieved_sources_step)
        ...
        workflow.add_edge("tool_retrieve", "store_retrieved_sources")
        workflow.add_edge("store_retrieved_sources", "grade_documents")
